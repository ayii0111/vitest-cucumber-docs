...
<Layout title="DocStrings">
    ...
    DataTables value is passed at last parmeters in your step callback : 
    ...
    You can use DataTable, DocStrings and step expression in same tests.
